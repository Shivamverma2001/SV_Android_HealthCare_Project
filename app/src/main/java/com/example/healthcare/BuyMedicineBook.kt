...
class BuyMedicineBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn.setOnClickListener {
            ...
            database.addOrder(username, name.text.toString(), email.text.toString(), contactNumber.text.toString(), pincode.text.toString().toInt(), date.toString(), time.toString(), price.toString().toFloat(), "medicine")
